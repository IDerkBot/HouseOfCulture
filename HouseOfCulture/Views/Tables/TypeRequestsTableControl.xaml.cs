...
{
    public partial class TypeRequestsTableControl : UserControl
    {
        public TypeRequestsTableControl()
        {
            InitializeComponent();
        }

        private void TypeRequestsTableControl_OnLoaded(object sender, RoutedEventArgs e)
        {
            DgData.ItemsSource = HouseOfCultureEntities.GetContext().TypeRequests.ToList();
        }
        ...
        {
            // Перемещаемся на страницу редактирования
            Navigation.Go(new TypeRequestEditControl());
        }
